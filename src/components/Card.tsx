...
<div className="flex justify-center">
    <div className="flex justify-between p-5 mt-20 mb-10 h-[66] w-1/3 overflow-scroll hover:bg-slate-200 border border-gray-400">
    
    <img className="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg" src="cardPhoto.jpg" alt=""/>
    ...
    {data.treneri.map((trener) => 
    {
        return (
            ...
            <div className="flex gap-3 text-gray-900 font-bold mb-2">
                <img className="w-20 h-20 rounded-full object-fill" src="cardPhoto.jpg" alt="pic" />
