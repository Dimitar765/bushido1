  ...
  return (
   ...
   <div className="flex bg-slate-200 min-h-screen">
        <div className="w-2/3 mt-20 ml-20">
            <p className="text-justify text-2xl p-12 tracking-tighter">
...
Od pocetka rada kluba, imamo nosioce zlatnih, srebrnih i bronzanih medalja sa kako balkanskih i evropskih, tako i svetskih takmicenja.
            </p>
        </div>
