  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 p-4">
        <div>
          <img className="h-auto max-w-full rounded-lg" src="1.jpeg" alt="" />
        </div>
        <div>
          <img className="h-auto max-w-full rounded-lg" src="2.jpeg" alt="" />
        </div>
        <div>
          <img className="h-auto max-w-full rounded-lg" src="3.jpg" alt="" />
        </div>
        <div>
          <img className="h-auto max-w-full rounded-lg" src="4.jpeg" alt="" />
        </div>
        <div>
